...
namespace Impact
{
    ...
    {
        public MessageListView() : this(ListViewCachingStrategy.RecycleElement)
        {
        }
        public MessageListView(ListViewCachingStrategy cachingStrategy) : base(cachingStrategy)
        {
        ...
        public static readonly BindableProperty TappedCommandProperty =
            BindableProperty.Create(nameof(TappedCommand), typeof(ICommand), typeof(MessageListView), default(ICommand));
        ...
        public static readonly BindableProperty ItemAppearingCommandProperty =
            BindableProperty.Create(nameof(ItemAppearingCommand), typeof(ICommand), typeof(MessageListView), default(ICommand));
        ...
        public static readonly BindableProperty ItemDisappearingCommandProperty =
         BindableProperty.Create(nameof(ItemDisappearingCommand), typeof(ICommand), typeof(MessageListView), default(ICommand));
        ...
        {
            var listView = (MessageListView)sender;
            if (e == null) return;
